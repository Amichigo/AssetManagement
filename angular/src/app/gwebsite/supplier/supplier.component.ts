import { ViewSupplierModalComponent } from './view-supplier-modal.component';
    ...
    export class SupplierComponent extends AppComponentBase implements AfterViewInit, OnInit {
        ...
        */
        ...
        @ViewChild('viewSupplierModal') viewSupplierModal: ViewSupplierModalComponent;
        ...
        */
        ...
        reloadList(supplierName, event?: LazyLoadEvent) {
            this._supplierService.getSuppliersByFilter(supplierName, this.primengTableHelper.getSorting(this.dataTable),
        ...
        init(): void {
            ...
            this._activatedRoute.params.subscribe((params: Params) => {
                this.supplierName = params['name'] || '';
                this.reloadList(this.supplierName, null);
            });
        }
