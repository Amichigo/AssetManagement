...
@Component({
    selector: 'app-sold-assets-data-table',
    templateUrl: './sold-assets-data-table.component.html',
    styleUrls: ['./sold-assets-data-table.component.css']
})
export class SoldAssetsDataTableComponent extends Component implements OnChanges {
   @Input() data;
   ...
   onExport() {
      this.excelService.exportAsExcelFile(this.dataToExport, 'Thống kê thanh lý tài sản');
   }
