...
@Component({
    selector: 'app-planned-to-purchase-assets-data-table',
    templateUrl: './planned-to-purchase-assets-data-table.component.html',
    styleUrls: ['./planned-to-purchase-assets-data-table.component.css']
})
export class PlannedToPurchaseAssetsDataTableComponent extends Component implements OnChanges {
   @Input() data;
   ...
   onExport() {
      this.excelService.exportAsExcelFile(this.dataToExport, 'Thống kê dự kiến mua tài sản');
   }
