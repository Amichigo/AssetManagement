...
export class TaiSanComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    */
    ...
    reloadList(taisanName, event?: LazyLoadEvent) {
        this._taisanService.getTaiSansByFilter(taisanName, this.primengTableHelper.getSorting(this.dataTable),
    ...
    init(): void {
        ...
        this._activatedRoute.params.subscribe((params: Params) => {
            this.taisanName = params['name'] || '';
            this.reloadList(this.taisanName, null);
        });
    }
