...
{
    public partial class AssetRentingContract : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AssetRentingContracts",
                columns: table => new
                {
                    ...
                    RentalPartner = table.Column<string>(nullable: true),
                    SignDate = table.Column<DateTime>(nullable: false),
                    LinkofImage = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetRentingContracts", x => x.Id);
                });
        }
