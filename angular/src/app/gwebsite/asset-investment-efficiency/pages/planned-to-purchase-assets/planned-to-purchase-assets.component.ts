...
const BASE_API_URL = 'http://localhost:5000/api/PlannedToPurchaseAsset';

@Component({
    templateUrl: './planned-to-purchase-assets.component.html',
    styleUrls: ['./planned-to-purchase-assets.component.css'],
    animations: [appModuleAnimation()]
})
export class PlannedToPurchaseAssetsComponent extends AppComponentBase implements OnInit {
    ...
    private section1Tabs = ['Giá trị dự kiến đầu tư', 'Số lượng tài sản dự kiến mua'];
    ...
    private section2Tabs = ['Giá trị dự kiến đầu tư', 'Số lượng tài sản dự kiến mua'];
            ...
            case 1:
                switch (comparisonMode) {
                    case 0:
                        switch (valueType) {
                            case 0:
                                this.loadTotalPlannedToPurchaseAssetsChartInOriginalValue();
                                break;

                            case 1:
                                this.loadTotalPlannedToPurchaseAssetsChartInPercentage();
                                break;
                        }
                        break;

                    case 1:
                        this.loadTotalPlannedToPurchaseAssetsChartWithComparison();
                        break;
                }
                break;
        }
    ...
    changeSection2(payload) {
        ...
        switch (activeTabIndex) {
            ...
            case 1:
                switch (valueType) {
                    case 0:
                        this.loadPlannedToPurchaseAssetsByTypesInOriginalValue();
                        break;

                    case 1:
                        this.loadPlannedToPurchaseAssetsByTypesInPercentage();
                        break;
                }
                break;
        }
    ...
    loadPlannedToPurchaseAssetsByTypesInPercentage() {
        let labels = [];
        let processedData = [];
    ...
    loadPlannedToPurchaseAssetsByTypesInOriginalValue() {
        let labels = [];
        let processedData = [];
        let abc = [];
    ...
    loadGeneralStatisticsData(data) {
        this.generalStatisticsData = [
            ...
            {
                title: 'Tổng số tài sản dự kiến mua',
                startingDate: this.startingDate,
                endingDate: this.endingDate,
    ...
    loadTotalPlannedToPurchaseAssetsChartInOriginalValue() {
        let labels = [];
        let processedData = [];
        ...
        this.section1Labels = labels;
        this.section1Data = [{ data: temp, label: 'Số lượng tài sản dự kiến mua (Tài sản)' }];
        this.section1YAxeLabel = 'Số lượng tài sản dự kiến mua (Tài sản)';
    }

    loadTotalPlannedToPurchaseAssetsChartInPercentage() {
        let labels = [];
        let processedData = [];
        ...
        this.section1Labels = labels;
        this.section1YAxeLabel = 'Tỉ lệ phần trăm so với tổng số lượng tài sản dự kiến mua (%)';
        this.section1Data = [{ data: temp, label: 'Tỉ lệ phần trăm so với tổng số lượng tài sản dự kiến mua (%)' }];
    }

    loadTotalPlannedToPurchaseAssetsChartWithComparison() {
        let processedData1 = [];
        let processedData2 = [];
        let labels = [];
