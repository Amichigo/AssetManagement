...
const BASE_API_URL = 'http://localhost:5000/api/PlannedToMaintainAsset';

@Component({
    templateUrl: './planned-to-maintain-assets.component.html',
    styleUrls: ['./planned-to-maintain-assets.component.css'],
    animations: [appModuleAnimation()]
})
export class PlannedToMaintainAssetsComponent extends AppComponentBase implements OnInit {
    ...
    private section1Tabs = ['Giá trị dự kiến đầu tư', 'Số lượng tài sản dự kiến bảo trì'];
    ...
    private section2Tabs = ['Giá trị dự kiến đầu tư', 'Số lượng tài sản dự kiến bảo trì'];
            ...
            case 1:
                switch (comparisonMode) {
                    case 0:
                        switch (valueType) {
                            case 0:
                                this.loadTotalPlannedToMaintainAssetsChartInOriginalValue();
                                break;

                            case 1:
                                this.loadTotalPlannedToMaintainAssetsChartInPercentage();
                                break;
                        }
                        break;

                    case 1:
                        this.loadTotalPlannedToMaintainAssetsChartWithComparison();
                        break;
                }
                break;
        }
    ...
    changeSection2(payload) {
        ...
        switch (activeTabIndex) {
            ...
            case 1:
                switch (valueType) {
                    case 0:
                        this.loadPlannedToMaintainAssetsByTypesInOriginalValue();
                        break;

                    case 1:
                        this.loadPlannedToMaintainAssetsByTypesInPercentage();
                        break;
                }
                break;
        }
    ...
    loadPlannedToMaintainAssetsByTypesInPercentage() {
        let labels = [];
        let processedData = [];
    ...
    loadPlannedToMaintainAssetsByTypesInOriginalValue() {
        let labels = [];
        let processedData = [];
        let abc = [];
    ...
    loadGeneralStatisticsData(data) {
        this.generalStatisticsData = [
            {
                title: "Tổng giá trị dự kiến đầu tư",
            ...
            {
                title: 'Tổng số tài sản dự kiến bảo trì',
                startingDate: this.startingDate,
                endingDate: this.endingDate,
    ...
    loadTotalInvestedAmountChartInOriginalValue() {
        ...
        this.section1Data = [{ data: temp, label: 'Giá trị dự kiến đầu tư (VNĐ)' }];
        this.section1YAxeLabel = 'Giá trị dự kiến đầu tư (VNĐ)';
    }
    ...
    loadTotalInvestedAmountChartInPercentage() {
        ...
        this.section1Labels = labels;
        this.section1Data = [{ data: temp, label: 'Tỉ lệ phần trăm so với tổng giá trị dự kiến đầu tư (%)' }];
        this.section1YAxeLabel = 'Tỉ lệ phần trăm so với tổng giá trị dự kiến đầu tư (%)';
    }
    ...
    loadTotalPlannedToMaintainAssetsChartInOriginalValue() {
        let labels = [];
        let processedData = [];
        ...
        this.section1Labels = labels;
        this.section1Data = [{ data: temp, label: 'Số lượng tài sản dự kiến bảo trì (Tài sản)' }];
        this.section1YAxeLabel = 'Số lượng tài sản dự kiến bảo trì (Tài sản)';
    }

    loadTotalPlannedToMaintainAssetsChartInPercentage() {
        let labels = [];
        let processedData = [];
        ...
        this.section1Labels = labels;
        this.section1YAxeLabel = 'Tỉ lệ phần trăm so với tổng số lượng tài sản dự kiến bảo trì (%)';
        this.section1Data = [{ data: temp, label: 'Tỉ lệ phần trăm so với tổng số lượng tài sản dự kiến bảo trì (%)' }];
    }

    loadTotalPlannedToMaintainAssetsChartWithComparison() {
        let processedData1 = [];
        let processedData2 = [];
        let labels = [];
