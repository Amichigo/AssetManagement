    ...
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
           ...
           // Asset_05
            ...
            //Permission
            configuration.CreateMap<GWebsite.AbpZeroTemplate.Core.Models.Permission, FlatPermissionDto>();
            configuration.CreateMap<GWebsite.AbpZeroTemplate.Core.Models.Permission, FlatPermissionWithLevelDto>();
